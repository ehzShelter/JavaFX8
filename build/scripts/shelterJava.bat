...
@rem ##########################################################################
@rem
@rem  shelterJava startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SHELTER_JAVA_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SHELTER_JAVA_OPTS%  -classpath "%CLASSPATH%" HelloFX %CMD_LINE_ARGS%
...
:fail
rem Set variable SHELTER_JAVA_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%SHELTER_JAVA_EXIT_CONSOLE%" exit 1
exit /b 1
